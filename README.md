...
3. **仓库上下文加载 (Context Loader)** ✨ v0.2.0
   - 自动检测项目根目录
   - 解析配置文件 (package.json, tsconfig.json, pyproject.toml, go.mod, Cargo.toml)
   - 提取依赖信息
   - 识别技术栈
   - 内存缓存机制
...
└─────────────────────────────────────────────────────────────────┘
                                ...
                                ▼
┌─────────────────────────────────────────────────────────────────┐
│  CONTEXT LOADER ✨ v0.2.0                                        │
│  - Detect project root                                           │
│  - Parse config files (package.json, tsconfig, etc.)            │
